...
const FooterComponent = () => {
    return (
        <footer className="bg-gradient-to-b from-[#052e16] to-[#031a0d] text-white py-16 mt-auto border-t border-emerald-500/20 shadow-lg">
            <div className="container mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 text-center md:text-left">
                ...
                <div className="space-y-6">
                    <div className="flex justify-center md:justify-start">
                        <Image src={Logo} alt="B2Y Future Labs Logo" width={220} height={60} className="animate-pulse" />
                    </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex justify-center md:justify-start gap-6">
                        <a href="#" aria-label="LinkedIn" className="p-4 rounded-full bg-white/10 hover:bg-emerald-400/20 transition duration-300">
                            <Linkedin className="w-6 h-6 text-white hover:scale-110 transition-transform" />
                        </a>
                        <a href="#" aria-label="Instagram" className="p-4 rounded-full bg-white/10 hover:bg-emerald-400/20 transition duration-300">
                            <Instagram className="w-6 h-6 text-white hover:scale-110 transition-transform" />
                        </a>
                        <a href="#" aria-label="Facebook" className="p-4 rounded-full bg-white/10 hover:bg-emerald-400/20 transition duration-300">
                            <Facebook className="w-6 h-6 text-white hover:scale-110 transition-transform" />
                        </a>
                        <a href="#" aria-label="Twitter" className="p-4 rounded-full bg-white/10 hover:bg-emerald-400/20 transition duration-300">
                            <Twitter className="w-6 h-6 text-white hover:scale-110 transition-transform" />
                        </a>
                    </div>
                </div>
            </div>
            ...
            {/* Mapa no Footer */}
            <div className="aspect-video w-full max-w-full h-80 rounded-lg overflow-hidden bg-white/10 mt-12">
                <iframe
            ...
            <div className="text-center mt-12 text-white/60 text-sm tracking-wide">
                &copy; {new Date().getFullYear()} B2Y Future Labs. <span className="text-emerald-400">tecnológicas que promovem sustentabilidade e impacto positivo no meio ambiente.</span>
            </div>
